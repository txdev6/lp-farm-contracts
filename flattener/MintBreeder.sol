...
// File: contracts/token/MintToken.sol
...
// File: contracts/farm/MintBreeder.sol
...
// MintBreeder is the master of PiggyToken.
contract MintBreeder is Ownable {
    ...
    function _pending(uint256 _pid, address _user) internal view returns (uint256) {
        ...
        if (block.number > pool.lastRewardBlock && lpSupply != 0) {
            ...
            // different interval different multiplier and mintPerBlock, sum piggyReward
